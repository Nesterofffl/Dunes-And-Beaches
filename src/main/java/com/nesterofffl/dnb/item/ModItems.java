...
public class ModItems {
    ...
    public static final Item Dried_Leather = registerItem("dried_leather", new Item(new Item.Settings().
            registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(DunesAndBeaches.MOD_ID,"dried_leather")))));

    public static final Item Art_Leather = registerItem("art_leather", new Item(new Item.Settings().
            registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(DunesAndBeaches.MOD_ID,"art_leather")))));

    private static Item registerItem(String name, Item item)
    {
        return Registry.register(Registries.ITEM, Identifier.of(DunesAndBeaches.MOD_ID, name), item);
    }
